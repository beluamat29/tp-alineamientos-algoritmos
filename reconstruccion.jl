...
function reconstruccion_top_down_2(str1, str2,  W)
    alineado_1 = str1
    alineado_2 = str2
    m = length(str1)
    n = length(str2)
    ...
    while m > 1 || n > 1
        if m == 1
            n -= 1
            alineado_1 = "-" * alineado_1
        elseif  n == 1
            m -= 1
            alineado_2 = "-" * alineado_2
        else
            gap_en_str2_mayor_gap_en_str1 = W[m-1, n] > W[m, n-1]
            ...
            if(gap_en_str2_mayor_gap_en_str1)
                ...
                if(gap_en_str1_mayor_mismatch)
                    ...
                    if m == length(alineado_1)
                        alineado_1 *= "-"
                    else
                        alineado_1 = alineado_1[1:m] * "-" * alineado_1[m+1:end]
                    end
