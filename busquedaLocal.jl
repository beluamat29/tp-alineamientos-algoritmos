...
function calcularScoreConGapsSwapeados(secuenciasConGapsAlterados, matrizDeScores) #paso la matriz por parametro para no instanciarla en cada iteracion
    ...
    for secuencia in secuenciasConGapsAlterados[1: end]
...
resultado = algoritmoGreedyRandom("archivo_de_cadenas.txt", matrizDeScores, 1.5)

talVezMejorResultado = busquedaLocal(resultado, 20, matrizDeScores)
